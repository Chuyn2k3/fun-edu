...
class _PdfGenerationScreenState extends State<PdfGenerationScreen> {
  ...
  Widget build(BuildContext context) {
    return BaseScaffold(
      ...
      appBar: CustomAppbar.basic(isLeading: true,title: "Tạo file PDF"),
                    ...
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        if (kIsWeb) {
                          ...
                          //   });
                          // });
                          final pdfBytes = await pdf.save(); // Chờ dữ liệu PDF
                          // await file
                          ...
                          // Hủy URL sau khi tải để giải phóng bộ nhớ
                          ...
                          final pdfBytes = await pdf.save(); // Chờ dữ liệu PDF
                          await file
                              .writeAsBytes(pdfBytes); // Ghi dữ liệu vào file
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => PdfViewer(
