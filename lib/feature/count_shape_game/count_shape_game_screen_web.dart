...
class CountShapesGameScreenWeb extends StatefulWidget {
  const CountShapesGameScreenWeb({Key? key}) : super(key: key);

  @override
  State<CountShapesGameScreenWeb> createState() =>
      _CountShapesGameScreenWebState();
}

class _CountShapesGameScreenWebState extends State<CountShapesGameScreenWeb>
  ...
  Future<void> _speakInstruction() async {
    try {
      await _flutterTts.stop(); // Đảm bảo không overlap
      final instruction =
