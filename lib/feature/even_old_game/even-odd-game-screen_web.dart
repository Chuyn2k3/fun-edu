...
class EvenOddGameScreenWeb extends StatefulWidget {
  const EvenOddGameScreenWeb({Key? key}) : super(key: key);

  @override
  State<EvenOddGameScreenWeb> createState() => _EvenOddGameScreenWebState();
}

class _EvenOddGameScreenWebState extends State<EvenOddGameScreenWeb>
  ...
  // ...giữ nguyên các hàm _buildGameContent, _buildStatBadge, _buildDropContainer, _buildAnswerButton...
...
// Widget chọn mode tích hợp ngay trong màn chơi
class _ModePicker extends StatelessWidget {
  final void Function(String mode) onSelect;
  const _ModePicker({required this.onSelect});
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFeatureCard(
            ...
            description: "Không giới hạn thời gian, vui học thỏa thích!",
