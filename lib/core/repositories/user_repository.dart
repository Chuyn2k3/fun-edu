...
abstract class UserRepository {
  Future<void> saveUserByDeviceId(UserInfoByDeviceIdModel request);
   Future<BaseResponse<UserInfoByDeviceIdModel>> getUserInfo({required String deviceId});
...
class UserRepositoryImpl implements UserRepository {
  ...
  @override
  Future<BaseResponse<UserInfoByDeviceIdModel>> getUserInfo({required String deviceId})async {
    try {
