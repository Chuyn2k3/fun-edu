...
import 'package:fun_edu/widget/base_button_v3.dart';
import 'package:fun_edu/widget/content_button.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      constraints: BoxConstraints(
          minHeight: minHeight ?? BaseButtonV3.minHeightButton(context)),
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          ...
          minimumSize: Size(0, BaseButtonV3.minimumSizeHeightButton(context)),
        ),
        onPressed: onPressed,
        child: child ??
            ContentButton(
