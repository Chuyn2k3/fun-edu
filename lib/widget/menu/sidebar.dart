...
// import 'package:font_awesome_flutter/font_awesome_flutter.dart'; // Add this dependency
...
//             colors: [
//               Color(0xFF6DD5FA), // xanh dương nhạt
//               Color(0xFF2980B9), // xanh dương đậm
//             ],
...
//         child: Column(
//           children: [
//             //Avatar vui nhộn ở đầu sidebar
//             Padding(
//               padding: const EdgeInsets.only(top: 32.0, bottom: 16.0),
//               child: CircleAvatar(
//                 radius: 36,
//                 backgroundColor: Color(0xFFFFE082), // vàng nhạt
//                 child: Icon(Icons.child_care,
//                     size: 48, color: Color(0xFFEC407A)), // hồng đậm
//               ),
//             ),
//             Visibility(
//               visible: isMobile,
...
//                 child: ListView(
//                   controller: _scrollController,
//                   padding: EdgeInsets.all(isMobile ? kDefaultPadding : 0),
//                   children: [
...
//         Assets.icons.iconCollapseSidebar,
//       ),
//     );
//   }
...
//             DateFormat('EEEE, dd/MM/yyyy HH:mm:ss').format(dateTime.toLocal());

//         return Center(
//           child: Text(
//             Const.dateDeploy(formattedDate),
...
//     //AppSidebarTheme sidebarTheme,
//     Color iconBgColor,
//   ) {
//     Widget iconChild;

//     // Priority: iconData > icon > iconSvgAsset > default
//     if (iconData != null) {
//       if (isFlutterAwesome) {
//         iconChild = FaIcon(
//           iconData,
//           //size: sidebarTheme.menuFontSize + 4,
//           color: Colors.white,
//         );
//       } else {
//         iconChild = Icon(
...
//         icon,
//         //width: sidebarTheme.menuFontSize + 4,
//         //height: sidebarTheme.menuFontSize + 4,
//         fit: BoxFit.contain,
//       );
...
//     // final Color bgColor =
//     //     Colors.primaries[colorIndex % Colors.primaries.length].shade100;
//     // final Color iconBgColor =
//     //     Colors.primaries[(colorIndex + 2) % Colors.primaries.length].shade200;
...
//             ? const Color(0xFFB2EBF2) // xanh cyan nhạt khi chọn
//             : Colors.transparent;
//         final Color iconBgColor = isSelected
//             ? const Color(0xFF0288D1) // xanh dương đậm khi chọn
//             : const Color(0xFF81D4FA); // xanh dương nhạt khi không chọn
...
//               hoverColor: bgColor.withOpacity(0.5),
//             ),
//           ),
//         );
//       },
...
//       padding: padding,
//       child: Card(
//         color: hasSelectedChild ? bgColor : Colors.transparent,
//         shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(18)),
//         elevation: hasSelectedChild ? 4 : 0,
//         margin: EdgeInsets.zero,
//         clipBehavior: Clip.antiAlias,
//         child: ExpansionTile(
//           key: UniqueKey(),
//           textColor: Colors.teal[900],
//           collapsedTextColor: Colors.blueGrey[800],
//           iconColor: Colors.teal,
//           collapsedIconColor: Colors.blueGrey,
//           backgroundColor: bgColor,
//           collapsedBackgroundColor:
//               (hasSelectedChild ? bgColor : Colors.transparent),
